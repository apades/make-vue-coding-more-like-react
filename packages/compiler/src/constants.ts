...
export const VINE_MACROS: Array<
  (typeof DECLARATION_MACROS)[number] | (typeof BARE_CALL_MACROS)[number]
> = [...DECLARATION_MACROS, ...BARE_CALL_MACROS]
...
export const SUPPORTED_CSS_LANGS = [
  'css',
  'scss',
  'sass',
  'less',
...
export const VineBindingTypes = {
  ...
  SETUP_REACTIVE_CONST:
    'setup-reactive-const' as VueBindingTypes.SETUP_REACTIVE_CONST,
  /**
